...
function ClosePrat1({ changePage, changeSection, startPage }) {
  ...
  return (
    <div className="ClosePrat1">
      ...
      <div className="ClosePrat1-content">
        <div className="ktzina-bubble ktzina-bubble-ClosePrat1">
          <div className={`bubble bubble-ClosePrat1${page}`}>
          ...
          <img src={ktzina} alt="ktzina" className="ktzina-ClosePrat1" />
        </div>
        {page === 0 && (
          <div className="closePrat1Img-container">
            <img src={closeImg} alt="closePrat1Img" className="closePrat1Img" />
            <button className={`closePrat1Btn ${finishedPractice ? "closePrat1Btn-disabled" : ""}`} onClick={()=> {setFinishedPractice(true)}}>
              אשר
            </button>
          </div>
        )}
