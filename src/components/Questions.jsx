  ...
  return (
    <div className="Questions">
      ...
      {page === 0 && <MultipleChoiceQuestion
        ...
        answers={[
          "צריך לבקש אישור ממגד כי הוא המפקד של ק אגם",
          "⁠אסור לשנות כי כבר סגרנו את הדוח",
      ...
      {page === 1 && <MultipleChoiceQuestion
        ...
        answers={[
          "תרגיל / אימון יחידתי",
          "אסור לבצע נוהל עבודה ידני",
          "תמיד ניתן לבצע נוהל עבודה ידני",
          "בעת אישור מסא״ל משא״ני",
          "העברת תקן",
          "אישור מפקד",
        ]}
        correctAnswers={[
