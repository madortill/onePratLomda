...
function StartPage({ changePage, setFullName }) {
      ...
      <div className="StartPage-Content">
        ...
        <div className="loginBox">
          <input
            ...
            placeholder="שם מלא"
            className="nameInput"
            onChange={(e) => checkHebrewName(e.target.value)}
            onKeyDown={handleKeyDown}
          />
        </div>
        <button
          className={`StartBtn ${canContinue ? "" : "StartBtnDisabled"}`}
